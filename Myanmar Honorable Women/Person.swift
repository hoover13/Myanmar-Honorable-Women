...
[Person(personName: "Aung San Suu Kyi", imageName: "Aung San Suu Kyi", arImageNameMMK: "Aung San Suu Kyi (MMK)", arImageNameUSD: "Aung San Suu Kyi (USD)", career: "State Counsellor", biography: "Aung San Suu Kyi, born in 1945, is a Burmese politician and Nobel Peace Prize laureate. Known for her nonviolent struggle against Myanmar's military junta, she served as State Counsellor from 2016 to 2021."),
 ...
 Person(personName: "Dar San Ye", imageName: "", arImageNameMMK: "???", arImageNameUSD: "Dar San Ye (USD)", career: "Civilian", biography: "Aung San Suu Kyi is the pre-democracy opposition leader in Myanmar, formerly known as Burma. She has been kept under detention for most of the past two decades."),
 ...
 Person(personName: "Khin Kyi", imageName: "Khin Kyi", arImageNameMMK: "Khin Kyi (MMK)", arImageNameUSD: "Khin Kyi (USD)", career: "Former Ambassador of Myanmar to India", biography: ""),
 ...
 Person(personName: "Oo Zun", imageName: "U Zun", arImageNameMMK: "Oo Zun (MMK)", arImageNameUSD: "Oo Zun (USD)", career: "Myanmar's first female social worker", biography: "The first social worker , Daw U Soon (1230-1306) was the first person to sow the seeds of social work for the care of the elderly in Myanmar today."),
 Person(personName: "Tin Tin Sein", imageName: "Tin Tin Sein", arImageNameMMK: "Tin Tin Sein (MMK)", arImageNameUSD: "Tin Tin Sein (USD)", career: "Myanmar's first female globetrotter", biography: "Tin Tin Sein, Myanmar's first female globetrotter, made history with her extensive travels worldwide. Born in 1919, she defied societal norms, exploring diverse cultures and documenting her adventures. Sein's pioneering spirit and love for exploration inspired generations of travelers in Myanmar and beyond."),
